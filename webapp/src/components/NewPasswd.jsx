...
import lock from '../assets/icons/lock-2-bold.png'
import eye from '../assets/icons/eye-line.png'
import lockline from '../assets/icons/lock-2-line.png'
			...
			<div>
				...
				<div className='lg:pl-30 lg:pr-30 sm:pr-20 sm:pl-20 pr-10 pl-10 ml-auto mr-auto mb-0 mt-20 md:mt-5 overflow-hidden'>
					...
					<div className='ml-auto mr-auto flex items-center flex-col mt-5 text-center'>
						...
						<h2 className='text-xl text-gray-600 mt-1'>Enter New Password</h2>
					</div>
